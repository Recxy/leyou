package com.leyou.common.config.mybatis.scan;
...
public @interface MapperScan {
	...
	/**
	 * This property specifies the annotation that the scan will search for.
	 * <p>
	 * The scan will register all interfaces in the base package that also
	...
	/**
	 * This property specifies the parent that the scan will search for.
	 * <p>
	 * The scan will register all interfaces in the base package that also
